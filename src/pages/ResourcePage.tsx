                        ...
                        <div className="flex flex-col items-center gap-6">
                            ...
                            <div className="flex items-center gap-4">
                                <a
                                    ...
                                    className="w-10 h-10 rounded-full bg-muted/40 hover:bg-primary/20 flex items-center justify-center transition-all hover:scale-110"
                                    aria-label="GitHub"
                                >
                            ...
                            <div className="text-center">
                                <p className="text-muted-foreground font-mono text-sm">
                                    &lt; <span className="text-primary font-semibold">jisun.online</span> /&gt;
                                </p>

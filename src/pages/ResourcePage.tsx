            ...
            <div className="min-h-screen bg-background relative overflow-hidden">
                ...
                <div className="relative z-10 py-20 px-4">
                    <div className="container mx-auto max-w-4xl">
                        ...
                        >
                            <motion.h1
                                className="text-4xl sm:text-6xl font-bold mb-6 text-gradient"
                            ...
                            {page.files && page.files.length > 0 ? (
                                page.files.map((file, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="relative p-8 rounded-2xl border border-border/50 group-hover:border-primary/30 transition-all">
                                            <div className="flex items-start gap-6">
                                                {/* Icon with Animation */}
                                                <motion.div
                                                    className="w-14 h-14 rounded-xl bg-gradient-to-br from-primary/20 to-primary/5 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform"
                                ...
                                >
                                    ...
                                    <p className="text-lg">No files available yet.</p>
                                </motion.div>
                            )}
                        </div>
                    </div>
                ...
                {/* Enhanced Footer */}
                <footer className="relative z-10 border-t border-border/50 mt-32 bg-background/50 backdrop-blur-sm">
                        ...
                        <div className="flex flex-col items-center gap-8">
                            ...
                            <div className="flex items-center gap-4">
                                <motion.a
                                    ...
                                    className="w-12 h-12 rounded-full bg-muted/40 hover:bg-primary/20 flex items-center justify-center transition-all group"
                                    aria-label="GitHub"
                            ...
                            <div className="text-center">
                                <Link to="/" className="group inline-block">
                                    ...
                                    >
                                        <p className="text-muted-foreground font-mono text-base sm:text-lg group-hover:text-foreground transition-colors">

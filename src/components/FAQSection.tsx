      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <header className="text-center mb-10 sm:mb-16">
          ...
          <p className="text-muted-foreground mt-3 sm:mt-4 max-w-2xl mx-auto text-sm sm:text-base px-2">
            Common questions about <strong>AI automation services</strong>, <strong>n8n automation</strong>, <strong>chatbot development</strong>, and working with <strong>Jisun Ahamed</strong>.
          </p>
        </header>
